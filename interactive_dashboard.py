...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        all_values.append(df1['class'].value_counts()[1])
        all_values.append(df2['class'].value_counts()[1])
        all_values.append(df3['class'].value_counts()[1])
        all_values.append(df4['class'].value_counts()[1])
        ...
        data={'Categories':[0,1], 'Values':[df['class'].value_counts()[0],df['class'].value_counts()[1]]}
        fig = px.pie(data,  
